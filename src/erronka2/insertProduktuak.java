...
public class insertProduktuak extends JFrame {
		...
		btnNewButton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ...
		        try {
		            ...
		            if (cn != null) {
		                String sql = "INSERT INTO produktuak (izena, prezioa, stock, egoera, konponketa, mota, irudia) "
		                           + "VALUES (?, ?, ?, ?, ?, ?, ?)";
