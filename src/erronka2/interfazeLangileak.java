...
public class interfazeLangileak extends JFrame {
	...
	private void kargatuTaula() {
		...
		modelo.setColumnIdentifiers(new String[] { "ID", "izena", "abizena", "erabiltzailea", "pasahitza", "rola"});
		table.setModel(modelo);
		


		DAO dao = new DAO();
		ArrayList<langileak> lista = dao.getLangileak();

		

		for (langileak l : lista) {
